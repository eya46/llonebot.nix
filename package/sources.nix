{ ... }:
{
  ...
  llonebot_version = "8.2.0";
  llonebot_url = "https://github.com/LLOneBot/LLOneBot/releases/download/v8.2.0/LLBot.zip";
  llonebot_hash = "sha256-eESmwlzR/TauvjPe8wraYFElRBqxgOBPTs+GGDf9uqQ=";
}
